...
var vm = new _vue2.default({
    ...
    methods: {
        getNowDetails: function getNowDetails() {
            this.getTime++;
...
var demo01Vm = new _vue2.default({
    el: "#demo01",
    data: {
        classObject: {
            active: true,
    ...
    methods: {
        ...
        pushArray: function pushArray() {
            this.items.push(JSON.parse(this.pushDetails));
        },
        arraySet: function arraySet() {
            var arr = JSON.parse(this.arrData);
            _vue2.default.set(this.items, arr.id - 1, arr);
        }
    }
});
